...
import me.xiaoying.turtle.api.module.JavaModule;
import me.xiaoying.turtle.api.module.Module;
...
public class PlaceholderModule extends PlaceholderExpansion {
    ...
    public @NotNull String getAuthor() {
        ...
        if (this.module instanceof JavaModule)
            ...
            authors = TCore.getInstance().getDescription().getAuthors();
    ...
    public @NotNull String getVersion() {
        return this.module instanceof JavaModule ? ((JavaModule) this.module).getDescription().getVersion() : TCore.getInstance().getDescription().getVersion();
    }
