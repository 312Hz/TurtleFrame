...
public class PlayerUtil {
    ...
    public static void sendActionbar(Player player, String message, int second) {
        int i = Bukkit.getScheduler().scheduleSyncRepeatingTask(TCore.getInstance(), () -> player.spigot().sendMessage(ChatMessageType.ACTION_BAR, new TextComponent(message)), 0L, 20L);
